...
```bash
wget https://github.com/yinpengfei/traffic-limiter/releases/download/v1.0.0/traffic-limiter-v1.0.0.tar.gz
...
traffic_ctl set-used 500        # 设置已用流量（校准用）
traffic_ctl reset               # 手动重置（续费后）
traffic_ctl limit 10mbit        # 手动限速
traffic_ctl unlimit             # 取消限速
traffic_ctl config edit         # 编辑配置
traffic_ctl dingtalk            # 配置钉钉通知
